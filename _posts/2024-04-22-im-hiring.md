...
Please send the following to [aszabo@pks.mpg.de] (subject line: "PhD opening"):
...
Please also arrange for two confidential letters of recommendation to be sent to [aszabo@pks.mpg.de] (subject line: "PhD reference {name of candidate}"). At least one of these should be written by a research (e.g., master's thesis) supervisor.
